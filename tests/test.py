...
stat_relev_genes_direct = JsonUtil.load_json(
    "results/run7 - without indirect annotations, p=0.05, 39 genes/statistically_relevant_genes.json"
)
gene_names_direct = []
...
stat_relev_genes_indirect = JsonUtil.load_json(
    "results/run8 - with indirect annotations, p=0.05, 130 genes/statistically_relevant_genes.json"
)
gene_names_indirect = []
