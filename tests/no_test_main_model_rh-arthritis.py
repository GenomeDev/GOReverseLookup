...
model = ReverseLookup.from_input_file("input_files/input_rhartritis_noortho.txt")
...
model.fetch_all_go_term_products(web_download=True, run_async=False, delay=0.5, max_connections=15)
