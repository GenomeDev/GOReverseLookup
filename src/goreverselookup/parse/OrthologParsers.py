...
class ZFINHumanOrthologFinder(HumanOrthologFinder):
    def __init__(self, filepath:str=""):
        ...
        """
        if filepath == "":
            self._filepath = "app/goreverselookup/data_files/zfin_human_ortholog_mapping.txt"
        else:
    ...
    def find_human_ortholog(self, product_id):
        ...
        def _zfin_get_human_gene_symbol_from_line(line):
            ...
            return human_symbol, human_gene_name # look at zfin orthologs txt file (in data_files) -> when you higlight a row, you see a TAB as '->' and a SPACEBAR as '.' -> splitting at \t means every [3] linesplit element is the human gene name
...
class XenbaseHumanOrthologFinder(HumanOrthologFinder):
    def __init__(self, filepath:str=""):
        ...
        """
        if filepath == "":
            self._filepath = "app/goreverselookup/data_files/xenbase_human_ortholog_mapping.txt"
        else:
            self._filepath = filepath
...
class MGIHumanOrthologFinder(HumanOrthologFinder):
    def __init__(self, filepath:str=""):
        ...
        """
        if filepath == "":
            self._filepath = "app/goreverselookup/data_files/mgi_human_ortholog_mapping.txt"
        else:
            self._filepath = filepath
...
class RGDHumanOrthologFinder(HumanOrthologFinder):
    def __init__(self, filepath:str=""):
        ...
        """
        if filepath == "":
            self._filepath = "app/goreverselookup/data_files/rgd_human_ortholog_mapping.txt"
        else:
            self._filepath = filepath
