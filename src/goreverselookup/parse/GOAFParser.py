...
class GOAnnotationsFile:
    def __init__(self, filepath:str="app/goreverselookup/data_files/goa_human.gaf", go_categories:list = ["biological_process", "molecular_activity", "cellular_component"]) -> None:
        """
